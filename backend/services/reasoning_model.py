...
based on prompt you have to summarize the brief and generated prompt by you, give a name for chat seession.
  ...
  "prompts": [
    {
      ...
      "aspect_ratio": "1:1",
      "chat_name":     "<short name for chat session summarizing the brief>"
    }
  ]
}"""
...
class ReasoningClient:
    ...
    def generate_prompts(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        chat_name      = prompt_objects[0].get("chat_name", "") if prompt_objects else ""
        ...
        return {"prompts": flat_prompts, "prompt_objects": prompt_objects, "chat_name": chat_name}
